...
methods:{
    ...
    load(){
      ...
      function select_json(new_json) {
        ...
        var svg = d3.select("#"+_this.id).append("svg")
        ...
        // d3.json(new_json, function() {
          ...
          new_json.links.forEach(function(link) {
        ...
        function row(rows) {
          d3.select(this).selectAll(".cell")
              ...
              .attr("width", width/matrix.length)
              .attr("height", width/matrix.length)
