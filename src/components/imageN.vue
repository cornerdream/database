...
<div id="img" >
    ...
    > -->
        ...
        <canvas id="galaxyCanvas" :width="canvasWidth" :height="canvasHeight" style="background: none transparent; border: none; margin: 0px; padding: 0px;"> </canvas>
        <v-slider
          v-model="fruits"
          :max="5"
          step="1"
...
mounted() {
    ...
    //   console.log(_this.wheelNumber,_this.fruits)
    //   _this.load2()
    //   console.log(_this.wheelNumber,_this.fruits)
    //   _this.sliderEnd(_this.wheelNumber)
    // }
    // this.load1()
    this.load2()
...
methods:{
    ...
    load2(){
      ...
      var min = this.scale[0]
      var max = this.scale[this.scale.length-1]
      this.galaxy2 = new CanvasZoom2( document.getElementById('galaxyCanvas'), './helloworld_files', 16384, 15360,size,min,max,this,256);
